...
def get_alt_source_cli_nav_string_from_args(args) -> str | None:
    """
    ...
    preceding_flags = ["--use-preceding-bookmark",
                       "-p", "--bookmark-alt-source", "-bs"]
    ...
    if IS_DEBUG:
        print(
            f"🔍 Debug - is_use_alt_source_bookmark: {alt_source_cli_nav_string}")
