...
from app.bookmarks.redis_states.handle_bookmark_redis_states import handle_bookmark_redis_states
...
def handle_matched_bookmark(
    ...
    if current_run_settings_obj["is_no_obs"]:
        print(f"📷 No-OBS mode: Skipping screenshot capture and metadata update")
    else:
